...
class ChildrenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post children_url, params: { child: { parent_id: @child.parent_id, password: @child.password, user: @child.user } }
    end
  ...
  test "should update child" do
    patch child_url(@child), params: { child: { parent_id: @child.parent_id, password: @child.password, user: @child.user } }
