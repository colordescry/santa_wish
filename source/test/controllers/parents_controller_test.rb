...
class ParentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parent" do
    assert_difference('Parent.count') do
      post parents_url, params: { parent: { password: @parent.password, user: @parent.user } }
    end
  ...
  test "should update parent" do
    patch parent_url(@parent), params: { parent: { password: @parent.password, user: @parent.user } }
