...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { buy: @wishlist.buy, child_id: @wishlist.child_id, name: @wishlist.name } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { buy: @wishlist.buy, child_id: @wishlist.child_id, name: @wishlist.name } }
